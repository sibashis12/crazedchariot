    ...
    <div className="container">
        <div className="home">
            ...
            <div className="component">
              ...
              <div className="section">
                <img alt="add-expense-description" src="https://img.freepik.com/free-vector/credit-score-flat-background-with-male-character-holding-coin-surrounded-by-round-compositions-financial-icons-vector-illustration_1284-83829.jpg?ga=GA1.1.1569983476.1727876886&semt=ais_hybrid"></img>
              </div>
            </div>
            {/* <div className="component">
              <div className="section">
            ...
            <div className="component">
              ...
              <div className="section">
                <img alt="visualize-description" src="https://img.freepik.com/free-vector/people-analyzing-growth-charts_23-2148866843.jpg?ga=GA1.1.1569983476.1727876886&semt=ais_hybrid"></img>
              </div>
            </div>
            <div className="component">
              <div className="section">
              ...
              <div className="section">
                <img alt="transactions-description" src="https://img.freepik.com/free-vector/business-team-brainstorming-discussing-startup-project_74855-6909.jpg?ga=GA1.1.1569983476.1727876886&semt=ais_hybrid"></img>
              </div>
            </div>
        </div>
    </div>
